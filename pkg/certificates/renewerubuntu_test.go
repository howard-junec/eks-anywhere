...
func TestRenewControlPlaneCertsWithExternalEtcdTransferError(t *testing.T) {
	...
	ssh.EXPECT().
		RunCommand(gomock.Any(), "cp-1", gomock.Any()).
		Return("", nil)
...
func TestRenewControlPlaneCertsWithCopyExternalEtcdCertsError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestCopyEtcdCertsWithEmptyCert(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
	...
	ssh.EXPECT().
		RunCommand(gomock.Any(), "etcd-1", gomock.Any()).
		Return("", nil)

	err := r.CopyEtcdCerts(context.Background(), "etcd-1", ssh)
	if err == nil {
		t.Fatalf("CopyEtcdCerts() expected error, got nil")
	}
}

func TestCopyEtcdCertsWithEmptyKey(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestTransferCertsToControlPlaneWithReadCertError(t *testing.T) {
	...
	err := r.TransferCertsToControlPlane(context.Background(), "cp-1", ssh)
	if err == nil {
...
func TestCopyEtcdCertsWithReadKeyError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestCopyEtcdCertsWithMkdirError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestCopyEtcdCertsWithWriteCertError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
...
func TestCopyEtcdCertsWithWriteKeyError(t *testing.T) {
	ctrl := gomock.NewController(t)
	defer ctrl.Finish()
